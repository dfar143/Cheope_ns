...
require_once(FRAMEWORK_PATH . "Cheope_ns_prova_57_op_page.class.php");

 $intHtmlFragment1 = new Html_fragment(OP_NONE,NUM_1);
 $intHtmlFragment1->setHtmlFragment("<div class=\"box\">Now you don't</div>" .
 "<div id=\"box\" class=\"box\" " .
 "style=\"background:blue\">Now you see me...(wipe)</div>");
...
/* $interfacesContainer->add($interfaceFrame1);
 ...
 $page = new Cheope_ns_prova_57_op_page();
