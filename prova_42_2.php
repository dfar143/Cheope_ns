...
require_once(FRAMEWORK_PATH . "Cheope_ns_prova_42_2_op_page.class.php");
 ...
 $interfaceScrollingTable1->setColumnsDim(array("33%","33%","33%"));
 ...
 ,TABELLA_PROVA_2=>FIELD_ID_PROVA_2,"QQ"));
 $interfaceScrollingTable2->setColumnsDim(array("33%","33%","33%"));

 $interfaceFragment1 = new Html_fragment(OP_NONE,NUM_1);
 $interfaceFragment1->setHtmlFragment("<div style=\"background-color:red;position:relative;top:0px;left:0px\">Ciao,ciao mare.<br/>Ciao,Ciao,mare...</div>");
 ...
 $interfaceMenuBar1 = new Cheope_ns_menuBar_2(OBJ_NONE,OP_NONE,NUM_1);
 ...
 $interfaceMenuBar1->setCssClass(CSS_MENUBAR_2);
 $interfaceMenuBar1->setDataSource(NO_DATA_SOURCE);
 
 $interfaceMenuBar2 = new Cheope_ns_menuBar_2($dbQueryQ_prova_2,OP_NONE,NUM_2);
 ...
 $interfaceMenuBar2->setCssClass(CSS_MENUBAR_2);
...
/* $interfacesContainer->add($interfaceFrame1);
 ...
 $page = new Cheope_ns_prova_42_2_op_page();
