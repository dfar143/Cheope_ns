...
require_once(FRAMEWORK_PATH . "Cheope_ns_prova_38_op_page.class.php");
 ...
 $fieldsDomainsValues = array(array("link1"=>array("Q"),"link2"=>"ciao2","link3"=>array("a","b")),
 array("link1"=>"ciaociao","link2"=>array("linkc"=>"c","d")));
 $interfaceNLevelsMenu1->setDataFieldsDomainsValues($fieldsDomainsValues);
 $interfaceNLevelsMenu1->setCssClass(STRING_SPACE);
 $interfaceNLevelsMenu1->setItemCssClass("menuItems");
 //$interfaceNLevelsMenu1->setItemsEvents(array("if(\$(this).children().css('display')=='none')" .
 //"{\$(this).children().css('display','block');event.stopPropagation();}" .
 //"else{\$(this).children().css('display','none');event.stopPropagation();};"));
 $interfaceNLevelsMenu1->setJavascriptEnabled(true);
...
/* $interfacesContainer->add($interfaceFrame1);
 ...
 $page = new Cheope_ns_prova_38_op_page();
