...
@Revison :    	1.5
@Date : 		12/2010
@Author:     	Surrel Mickaël (www.msconcept.fr)  -  Croissance Net (www.croissance-net.com)
...
THANKS TO SEND ME AN EMAIL, IT WILL BE GREAT  :)   !! 
 --  contact@msconcept.fr  --
	...
	$.jMenu = {
		...
		init:function(options){
			...
			$('#jMenu').hover(function(){},function(){
				setTimeout(function(){$.jMenu._closeAll();},opts.LatenceTime);
			});
		},
		...
		****************************/
		...
		_show:function(el) {
			...
			{
				case 'slide':
					el.slideDown(opts.effects.effectSpeedOpen, opts.effects.effectOpen);
					break;
				case 'fade':
					el.fadeIn(opts.effects.effectSpeedOpen, opts.effects.effectOpen);
					break;
				default :
					el.show(opts.effects.effectSpeedOpen, opts.effects.effectOpen);
			}
		},
