...
require_once(FRAMEWORK_PATH . "Cheope_ns_prova_12_op_page.class.php");
 ...
 /*$interfacesContainer1->add($interfaceTextarea1);*/
 ...
 $interfaceJavascriptTxtEditor1->setFileName('Testo_prova_12.txt');
 ...
 $page = new Cheope_ns_prova_12_op_page();
 $page->setInterfacesContainer($interfacesContainer);
 $page->setCREnabled(true);
 $page->setJQueryEnabled(true);
 $page->setAjaxOps(array(AJAX_OP_GET_FILE,AJAX_OP_SEND_FILE));
 $page->putData();
