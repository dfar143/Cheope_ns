...
require_once(FRAMEWORK_PATH . "Cheope_ns_prova_70_op_page.class.php");

 $interfaceHtmlFragment1 = new Html_fragment(OP_NONE,NUM_1);
 $interfaceHtmlFragment1->setHtmlFragment("<div id='gridContainer4' style='width: 100%; height: 100%;'></div>");
 ...
 $page = new Cheope_ns_prova_70_op_page();
