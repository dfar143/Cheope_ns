...
require_once(FRAMEWORK_PATH . "Cheope_ns_prova_23_op_page.class.php");
 ...
 " jsId=\"coffeeStore\" url=\"./coffee.json\"></div><form dojoType=\"dijit.form.Form\" action=\"prova_23.php\">" .
 "<select dojoType=\"dijit.form.FilteringSelect\" name=\"coffee\" searchAttr=\"name\" store=\"coffeeStore\"> " .
