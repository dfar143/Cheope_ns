...
require_once(FRAMEWORK_PATH . "Cheope_ns_queries_op_page.class.php");
 ...
 $fieldsDomainsValues = array(array("Db parameters","Tables","Fields","Import"),
 array("db_parameters.php","tables.php","fields.php","import.php"),
 ...
 $interfaceLabelTag1->setTagBody(LABEL_CORPO_QUERY);
 
 $interfaceTextareaTag1 = Creator::create(Interfaces_info::INT_HTML_TEXTAREA_TAG,STRING_NULL);
 ...
 "style"=>"float:left;cursor:pointer;","title"=>LABEL_IMPOSTA_NUOVA_QUERY,
 "onclick"=>"var nuova_query=\$('#Nuova_query').get(0).value;" .
 "if(nuova_query != '')" .
 "form_inserimento_1_nuova_query_onChange(nuova_query);" .
 "else alert(loc.getString('msg',40));"));
 ...
 $dataFields = array(FIELD_IMG_TRASF,FIELD_LISTA_QUERIES,FIELD_NUOVA_QUERY,FIELD_QUERY_BODY);
 $interfaceForm1->setDataFields($dataFields);
 $fieldsLengths = array(FIELD_NUOVA_QUERY=>40);
 $interfaceForm1->setFieldsLengths($fieldsLengths);
 $fieldsDomains = array(Int_domain::FIELD_DOMAIN_OBJ,Int_domain::FIELD_DOMAIN_SET,
 Int_domain::FIELD_DOMAIN_ATOMIC,Int_domain::FIELD_DOMAIN_OBJ);
 $interfaceForm1->setDataFieldsDomains($fieldsDomains);
 $fieldsDomainsValues = array($interfaceImg1,Int_domain::FIELD_DOMAIN_VALUE_NONE ,
 Int_domain::FIELD_DOMAIN_VALUE_NONE ,$interfaceDivTag1);
 ...
 FIELD_LISTA_QUERIES=>array("form_inserimento_1_lista_queries_onChange(this);"));
 ...
 $attribs = array("type"=>"button","id"=>"button_1","value"=>LABEL_CREA_FILE_STRUTTURA_QUERIES,
 ...
 $attribs = array("type"=>"button","value"=>LABEL_VEDI_TUTTE_QUERY,
 "onclick"=>"button_3_onClick();");
 $interfaceSubmitButton2->setAttribs($attribs);
 
 $interfaceSubmitButton4 = Creator::create(Interfaces_info::INT_HTML_INPUT_TAG,STRING_NULL);
 //$interfaceSubmitButton4 = new Html_input_tag();
 $attribs = array("type"=>"button","value"=>LABEL_VEDI_TUTTE_INTERFACCE_ASSOCIATE,
 "onclick"=>"button_4_onClick();");
 $interfaceSubmitButton4->setAttribs($attribs);
 
 $interfaceSubmitButton3 = Creator::create(Interfaces_info::INT_HTML_INPUT_TAG,STRING_NULL);
 //$interfaceSubmitButton3 = new Html_input_tag();
 $attribs = array("type"=>"button","value"=>LABEL_ESEGUI,
 ...
 //$intSpan = new Html_span_tag();
 $intSpan->setTagBody(ENTITY_SPACE);
 
 $interfaceDivTagContainer2->add($interfaceSubmitButton1);
 $interfaceDivTagContainer2->add($interfaceSubmitButton2);
 $interfaceDivTagContainer2->add($intSpan);
 $interfaceDivTagContainer2->add($interfaceSubmitButton4);
 $interfaceDivTagContainer2->add($intSpan);
 $interfaceDivTagContainer2->add($interfaceSubmitButton3);
 ...
 $interfaceHtmlFragment1->setHtmlFragment("<div id=\"dialog-confirm\" style=\"display:none;\" title=\"Create table?\">" .
  "<p><span class=\"ui-icon ui-icon-alert\" style=\"float:left; margin:0 7px 20px 0;\"></span>" . MSG_51 . "</p>" .
 "</div>");
...
//$interfacesContainer = new Interfaces_container(CONTENITORE_GLOBALE_INTERFACCE);
 ...
 //$page = new Cheope_ns_queries_op_page();
 $ajaxOps = array(AJAX_OP_GET_QUERY,AJAX_OP_SET_QUERY,
 AJAX_OP_CREATE_QUERIES_STRUCT,AJAX_OP_CHECK_IF_IS_DATA_SOURCE_QUERY,
 AJAX_OP_CREATE_DB_STRUCT,
 AJAX_OP_CREATE_DB_BINDS,AJAX_OP_UPDATE_BINDS,
 AJAX_OP_GET_NODE_TYPE,AJAX_OP_CHECK_IF_NODE_IS_USED,
