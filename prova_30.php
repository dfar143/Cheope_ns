...
require_once(FRAMEWORK_PATH . "Cheope_ns_prova_30_op_page.class.php");

 $interfaceHtmlFragment1 = new Html_fragment(OP_NONE,NUM_1);
 $interfaceHtmlFragment1->setHtmlFragment("<div dojoType=\"dijit.ColorPalette\"> " .
 "<script type=\"dojo/method\" event=\"onChange\" args=\"selectedColor\">alert(selectedColor);this.destroy();</script></div>");
 ...
 $page = new Cheope_ns_prova_30_op_page();
