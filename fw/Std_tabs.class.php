...
class Std_tabs extends Html_data_interface
{
 
// const ERROR_1="Std_tabs:Errore nell'inserimento dell'interface container.";
 const VOICES_POS=0;
 ...
 function setSelectedTab(int|string $actSel):void
 {
  $this->selectedTab = $actSel;
 }
 
 function getSelectedTab():int|string
 {
