...
define('DEFAULT_PAGE_NAME',"prova_31");
define('THIS_PAGE',PAGE_PROVA_31);

class Cheope_ns_prova_31_op_page extends Cheope_ns_page
{
 ...
 function putClientScriptIncludeCode():void
 {
  ...
  putGenericHtmlString("<script>dojo.require(\"dijit.Toolbar\")</script>"); 
