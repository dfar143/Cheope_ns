...
class Cheope_ns_slide_down extends Html_data_interface
{
 const ERROR_1="Cheope_ns_slide_down.putData:Numero campi dati errato.";
 const TITLES_POS=0;
 const PAGES_POS=1;
 const LINKS_POS=2;
 const DEFAULT_CSS_CLASS="slide_down";
 const DEFAULT_JAVASCRIPT_MODULE=JS_SLIDE_DOWN;
 const DEFAULT_CSS_MODULE="slide_down";
 const SLIDE_DOWN_HEADER_ID = "slide_down";
 ...
 function __construct($actObj=OBJ_NONE,string $actOp=OP_NONE,$actNum=STRING_NULL)
 {
  ...
  parent::__construct($actObj,$actOp,self::INT_SLIDE_DOWN,$actNum);
  $this->setJavascriptModule(CLIENT_SLIDE_DOWN_CODE_PATH . DIR_SEP . self::DEFAULT_JAVASCRIPT_MODULE);
 ...
 function putMenu(array $actDataValues):void
 {
  ...
  $htmlWriter->putDivOpenTag(self::SLIDE_DOWN_HEADER_ID,$style,STRING_NULL);
  $i=0;
