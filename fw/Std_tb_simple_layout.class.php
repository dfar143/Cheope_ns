...
class Std_tb_simple_layout extends Html_formatted_interface
{ 
 
// const ERROR_1="Std_tb_simple_layout:Errore nell'inserimento dell'interface container di sinistra.";
// const ERROR_2="Std_tb_simple_layout:Errore nell'inserimento dell'interface container di destra.";
