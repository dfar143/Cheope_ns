...
define('DEFAULT_PAGE_NAME',"prova_38_2");
define('THIS_PAGE',PAGE_PROVA_38_2);

class Cheope_ns_prova_38_2_op_page extends Cheope_ns_page
{
 ...
 function putClientScriptIncludeCode():void
 {
	 ...
	 $htmlWriter->putGenericHtmlString('var flag_nLevels_menu_0=true;');
	 $htmlWriter->putGenericHtmlString('var flag_nLevels_menu_1=true;');
	 $htmlWriter->putGenericHtmlString('var flag_nLevels_menu_2=true;');
	 $htmlWriter->putGenericHtmlString('var flag_nLevels_menu_3=true;');
