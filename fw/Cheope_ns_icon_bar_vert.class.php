...
class Cheope_ns_icon_bar_vert extends Html_data_interface
{
 const ERROR_1="Cheope_ns_icon_bar_vert.putData:Numero campi dati errato.";
 const ICONS_NAMES_POS=0;
 const PAGES_POS=1;
 const LINKS_POS=2;
 const DEFAULT_CSS_CLASS="icon_bar_vert";
 const DEFAULT_CSS_MODULE="icon_bar_vert";
 ...
 function __construct($actObj=OBJ_NONE,string $actOp=OP_NONE,$actNum=STRING_NULL)
 {
  ...
  parent::__construct($actObj,$actOp,self::INT_ICON_BAR_VERT,$actNum);
 ...
 function putMenu(array $actDataValues):void
 {
  ...
  foreach($iconsNames as $ind=>$iconName)
  {
	...
	if($i==0)
	{
     $htmlWriter->putHrefOpenTag(STRING_NULL,STRING_NULL,"icon_bar_vert_active",$link);
    }
	else
    {
