...
define('DEFAULT_PAGE_NAME',"prova_33");
define('THIS_PAGE',PAGE_PROVA_33);

class Cheope_ns_prova_33_op_page extends Cheope_ns_page
{
 ...
 function putClientScriptIncludeCode():void
 {
  ...
  $htmlWriter->putGenericHtmlString("<script>dojo.require(\"dijit.InlineEditBox\")</script>"); 
  $htmlWriter->putGenericHtmlString("<script>dojo.require(\"dijit.Tooltip\")</script>"); 
  $htmlWriter->putGenericHtmlString("<script>" .
	"dojo.addOnLoad(function(){var tooltip=new dijit.Tooltip({connectId:'frame__1'," .
      "label:'OK',position:'above'});dojo.parser.parse();document.body.className='nihilo';});</script>");
 }
