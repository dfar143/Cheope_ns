...
class Cheope_ns_bootstrap_carousel extends Html_data_interface
{
 const ERROR_1 = "Cheope_ns_bootstrap_carousel:Numero campi dati errato.";
 const ERROR_2 = "Cheope_ns_boostrap_carousel:Numero etichette maggiore del numero di interfacce."; 	
