...
abstract class Xml_data_interface extends Xml_formatted_interface 
{
 Use Creator;
//const ERROR_1="Html_data_interface:Errore nell'inserimento del grafo del database.";
 const ERROR_2="Xml_data_interface:Errore nell'inserimento del nodo dati.";
// const ERROR_3="Html_data_interface:Errore nell'inserimento dell'int_fields_container.";
 const ERROR_4="Xml_data_interface:Errore nell'inserimento dei domains values:Oggetto dominio campo dati non esistente.";
 const ERROR_5="Xml_data_interface:Errore in setDataFieldDomainValueByPos: Oggetto dominio campo dati non esistente.";
 const ERROR_6="Xml_data_interface:Errore Grafo del database vuoto.";
 const ERROR_7="Xml_data_interface:Errore Contenitore delle queries vuoto.";
// const ERROR_8="Html_data_interface:Errore nell'inserimento del contenitore queries.";
 const ERROR_9="Xml_data_interface:Errore Dominio non valido.";
 const ERROR_10="Xml_data_interface:Errore Oggetto non valido.";
 const ERROR_11="Xml_data_interface:Errore Dominio non settato per il campo.";
...
// const ERROR_12="Html_data_interface:l'Argomento deve essere un array.";
 ...
 static private $xmlDataInterfacesTotNum = 0;
 ...
 {
  $serializer = Creator::create(getClassNameForCreate(Classes_info::XML_SERIALIZER_CLASS),
  STRING_NULL,CLIENT_XML_PATH . DIR_SEP . self::getXmlDataSourceCanonicalName($actObj,$par1));
  return $serializer; 
 }
 ...
 {
  $serializer = Creator::create(getClassNameForCreate(Classes_info::JSON_SERIALIZER_CLASS),STRING_NULL,
  CLIENT_JSON_PATH . DIR_SEP . self::getJsonDataSourceCanonicalName($actObj,$par1));
  return $serializer; 
 }
 ...
 static function createJsonNode(Generic_interface $actObj=null,string $par1=STRING_NULL):Json_node
 {
  ...
  $jsonNode = Creator::create(getClassNameForCreate(Classes_info::JSON_NODE_CLASS),STRING_NULL,$serialiser);
  return $jsonNode;
 }
 ...
 function getInheritDataFieldName():void
 {
 ...
 $actFieldDomainValue=Int_domain::FIELD_DOMAIN_VALUE_NONE,
...
// 
 ...
 function getDataFieldDomainByPos(int $actPos):bool
 {
...
//   die(self::ERROR_12);    
 ...
 function setDataFieldDomainValueByPos(int $actPos,$actVal):bool
 {
  $intFieldsContainer = $this->getIntFieldsContainer();
  $intFieldsIterator = $intFieldsContainer->create();
  $intFieldsIterator->reset();
 ...
 function setDataFieldDomainValueByName(string $actFieldName,$actVal):bool
 {
  $intFieldsContainer = $this->getIntFieldsContainer();
  $intFieldsIterator = $intFieldsContainer->create();
  $intFieldsIterator->reset();
 ...
 $actFieldVal=FIELD_NO_VALUE,
 $actId=FIELD_ID_NO_VALUE):mixed
 {
