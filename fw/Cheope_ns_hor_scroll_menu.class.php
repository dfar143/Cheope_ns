...
class Cheope_ns_hor_scroll_menu extends Html_data_interface
{ 
 const ERROR_1="Cheope_ns_hor_scroll_menu.putData:Numero campi dati errato.";
 const DEFAULT_CSS_CLASS="scrollmenu";
 const DEFAULT_CSS_MODULE="hor_scroll_menu";
 const PAGES_POS=1;
 const TITLES_POS=0;
 const LINKS_POS=2;
 ...
 function __construct($actObj=OBJ_NONE,string $actOp=OP_NONE,$actNum=STRING_NULL)
 {
  ...
  parent::__construct($actObj,$actOp,self::INT_HOR_SCROLL_MENU,$actNum);
