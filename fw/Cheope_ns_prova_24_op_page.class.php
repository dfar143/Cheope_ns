...
define('DEFAULT_PAGE_NAME',"prova_24");
define('THIS_PAGE',PAGE_PROVA_24);

class Cheope_ns_prova_24_op_page extends Cheope_ns_page
{
 ...
 function putClientScriptIncludeCode():void
 {
  ...
  putGenericHtmlString("<script>dojo.require(\"dijit.form.ComboBox\")</script>");
