...
class Cheope_ns_bootstrap_jumbotron extends Html_formatted_interface
{
 ...
 function setBootstrapInnerContainerType(string $actBootstrapInnerContainerType)
 {
 ...
 function setInnerInterface(?Html_formatted_interface $actInnerInterface)
 {
