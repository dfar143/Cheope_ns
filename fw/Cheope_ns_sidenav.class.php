...
class Cheope_ns_sidenav extends Html_data_interface
{
 const ERROR_1="Cheope_ns_sidenav.putData:Numero campi dati errato.";
 const TITLES_POS=0;
 const PAGES_POS=1;
 const LINKS_POS=2;
 const DEFAULT_CSS_CLASS="sidenav";
 const DEFAULT_CSS_MODULE="sidenav";
 const DEFAULT_JAVASCRIPT_MODULE_1 = "sidenav_overlay";
 const DEFAULT_JAVASCRIPT_MODULE_2 = "sidenav_push_content";
 const DEFAULT_JAVASCRIPT_MODULE_3 = "sidenav_push_content_opacity";
 const DEFAULT_JAVASCRIPT_MODULE_4 = "sidenav_full_width";
 ...
 private $mainContentId=STRING_NULL;
 ...
 function __construct($actObj=OBJ_NONE,string $actOp=OP_NONE,$actNum=STRING_NULL)
 {
  ...
  parent::__construct($actObj,$actOp,self::INT_SIDENAV,$actNum);
  $this->setCSSModule(array(CLIENT_STYLE_SHEET_PATH . DIR_SEP . self::DEFAULT_CSS_MODULE . STYLE_SHEET_FILE_POSTFIX));
  //$this->setJavascriptModule(CLIENT_SIDENAV_CODE_PATH . DIR_SEP . JS_SIDENAV_1  . namespace\JAVASCRIPT_SOURCE_FILE_POSTFIX);
  $this->setJavascriptModule(CLIENT_SIDENAV_CODE_PATH . DIR_SEP . JS_SIDENAV_1  . namespace\JAVASCRIPT_SOURCE_FILE_POSTFIX);
 }
 ...
 function serialize():void
 {
	...
	$item7 = array("mainContentId"=>$mainContentId);
 ...
 function getMainContentId():string
 {
  return $this->mainContentId;
 }
 
 function setMainContentId(string $actMainContentId):void
 {
	$this->mainContentId = $actMainContentId;
 }
 ...
 function putMenu(array $actDataValues):void
 {
  ...
  $htmlWriter->putDivOpenTag("mySidenav",$style,$cssClass);
  $i=0;
  $mainContentId = $this->getMainContentId();
  $htmlWriter->putHrefOpenTag(STRING_NULL,STRING_NULL,"closebtn","javascript:void(0)",STRING_NULL,STRING_NULL,STRING_NULL,STRING_NULL,"sidenav_closeNav('" . $mainContentId . "')");
 ...
 { 
  ...
  {
   $mainContentId = $this->getMainContentId();	  
   $htmlWriter->putSpanOpenTag(STRING_NULL,STRING_NULL,"sidenav_openNav('" . $mainContentId . "')");
