...
class Cheope_ns_fixed_top_menu extends Html_data_interface
{
 const ERROR_1="Cheope_ns_fixed_top_menu.putData:Numero campi dati errato.";
 const TITLES_POS=0;
 const PAGES_POS=1;
 const LINKS_POS=2;
 const DEFAULT_CSS_CLASS="fixed_top";
 const DEFAULT_CSS_MODULE="fixed_top";
 ...
 function __construct($actObj=OBJ_NONE,string $actOp=OP_NONE,$actNum=STRING_NULL)
 {
  ...
  parent::__construct($actObj,$actOp,self::INT_FIXED_TOP_MENU,$actNum);
