...
class Cheope_ns_equal_width_navbar extends Html_data_interface
{
 const ERROR_1="Cheope_ns_equal_width_navbar.putData:Numero campi dati errato.";
 const TITLES_POS=0;
 const ICONS_NAMES_POS=1;
 const PAGES_POS=2;
 const LINKS_POS=3;
 const DEFAULT_CSS_CLASS="ew_navbar";
 const DEFAULT_CSS_MODULE="ew_navbar";
 ...
 function __construct($actObj=OBJ_NONE,string $actOp=OP_NONE,$actNum=STRING_NULL)
 {
  ...
  parent::__construct($actObj,$actOp,self::INT_EQUAL_WIDTH_NAVBAR,$actNum);
