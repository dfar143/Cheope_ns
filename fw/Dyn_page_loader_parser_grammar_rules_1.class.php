...
{
$res16=$parser->match(Token::TYPE_SPECIAL_ITEM,DYN_PAGE_LOADER_TOKEN_VAL_FSLASH);
...
{
	$nTok = Creator::create(getClassNameForCreate(Classes__info::TOKEN_CLASS),STRING_NULL);
//$nTok = new Token();
...
{
	$nTok = Creator::create(getClassNameForCreate(Calsses_info::TOKEN_CLASS),STRING_NULL);
//$nTok = new Token();
$nTok->setAttribute(DYN_PAGE_LOADER_TOKEN_ATTR_HTML_TAG);
$lexema = $tok->getLexema();
