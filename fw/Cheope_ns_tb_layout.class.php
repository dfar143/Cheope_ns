...
class Cheope_ns_tb_layout extends Html_formatted_interface
{ 
 
// const ERROR_1="Cheope_ns_tb_layout:Errore nell'inserimento dell'interface container di sinistra.";
// const ERROR_2="Cheope_ns_tb_layout:Errore nell'inserimento dell'interface container di destra.";
 ...
 const DEFAULT_WITH_CONTAINER=true;
 ...
 {
 	if($this->withContainer == STRING_NULL)
 	 return self::DEFAULT_WITH_CONTAINER;
 	else
 ...
 function serialize():void
 {
	...
	//$textPropsArray=array("containerStyle","containerTopStyle","containerBottomStyle");
