...
require_once("FCKEditor.class.php");
require_once("Html_data_template.class.php");


define('DEFAULT_PAGE_NAME',"prova_13");
define('THIS_PAGE',PAGE_PROVA_13);

class Cheope_ns_prova_13_op_page extends Cheope_ns_page
{
