...
class Std_nLevels_tree_ctrl extends Std_tree_ctrl
{
 ...
 const ERROR_1 = "Std_nLevels_tree_ctrl:Oggetto dati non valido.";
 const ERROR_2="Std_nLevels_tree_ctrl:Numero campi dati errato.";
