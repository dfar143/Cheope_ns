...
define('DEFAULT_PAGE_NAME',"Prova_dyn_page_loader");
define('THIS_PAGE',"Prova_dyn_page_loader.php");
class Cheope_ns_Prova_dyn_page_loader_op_page extends Cheope_ns_page
{
