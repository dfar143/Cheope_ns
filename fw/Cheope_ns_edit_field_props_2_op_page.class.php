...
define('DEFAULT_PAGE_NAME',"edit_field_props_2");
define('THIS_PAGE',"edit_field_props_2.php");


class Cheope_ns_edit_field_props_2_op_page extends Cheope_ns_page
{
 ...
 function putBody():void
 {
 	...
 	if(isset($_SESSION[SESSION_VAR_USER])&&($_SESSION[SESSION_VAR_USER]!=STRING_NULL))
 	{
   $int_iter = $interfaces->create();
   $int = $int_iter->last();
   $int->putData();  
 }
 elseif(isset($_SESSION[SESSION_VAR_USER]) && $_SESSION[SESSION_VAR_USER]==STRING_NULL)
 {
