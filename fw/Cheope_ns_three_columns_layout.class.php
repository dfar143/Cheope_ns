...
class Cheope_ns_three_columns_layout extends Html_formatted_interface
{ 

// const ERROR_1="Cheope_ns_three_columns_layout:Errore nell'inserimento dell'interface container di sinistra.";
// const ERROR_2="Cheope_ns_three_columns_layout:Errore nell'inserimento dell'interface container di destra.";
 const DEFAULT_CSS_CLASS="three_columns_layout";
 ...
 const DEFAULT_CONTAINER_LEFT_STYLE = "width:33%;height:100%";
 const DEFAULT_CONTAINER_CENTER_STYLE = "width:33%;height:100%";
 const DEFAULT_CONTAINER_RIGHT_STYLE = "width:33%;height:100%";
 ...
 private $containerCenterStyle=self::DEFAULT_CONTAINER_CENTER_STYLE;
 ...
 function __construct(string $actOp=OP_NONE,$actNum=STRING_NULL)
 {
  ...
  parent::__construct($actOp,self::INT_THREE_COLUMNS_LAYOUT,$actNum=0);
 }
 ...
 function setContainerCenterStyle(string $actContainerCenterStyle):void
 {
 	$this->containerCenterStyle = $actContainerCenterStyle;
 }
 
 function getContainerCenterStyle():string
 {
 	if($this->containerCenterStyle == STRING_NULL)
 	 return self::DEFAULT_CONTAINER_CENTER_STYLE;
 	else
 	 return $this->containerCenterStyle;
 }
 ...
 function enableBootstrap():void
 {
 	...
 	if ($bootstrapEnabled)
 	{
 		...
 		isset($this->interfacesContainerCenter)||
 ...
 function serialize():void
 {
	...
	//$booleanPropsArray=array("withContainer");
	//$textPropsArray=array("containerStyle","containerLeftStyle","containerCenterStyle","containerRightStyle");
	...
	if(is_null($intContLeft))
 	...
 	$intContCenter = $this->getInterfacesContainerCenter();
	if(is_null($intContCenter))
	 $intContCenter = self::createInterfacesContainer();
	...
	if(is_null($intContRight))
 	...
 	$containerCenterStyle = $this->getContainerCenterStyle();
 	...
 	$item6 = array("containerCenterStyle"=>$containerCenterStyle);
 	$serializer->loadItems($item6);
 	$item7 = array("containerRightStyle"=>$containerRightStyle);
 	$serializer->loadItems($item7);
 	$item8 = array("interfacesContainerLeft"=>$intContLeft);
 	$serializer->loadItems($item8);
 	$item9 = array("interfacesContainerCenter"=>$intContCenter);
 	$serializer->loadItems($item9);
 	$item10 = array("interfacesContainerRight"=>$intContRight);
...
function setBootstrapContainerType(string $actBootstrapContainerType):void
{
 ...
 function getBootstrapContainerType():string
 {
 	if($this->bootstrapContainerType == STRING_NULL)
 	 return self::DEFAULT_BOOTSTRAP_CONTAINER_TYPE_1;
 	else
...
function setBootstrapViewPortSizeType(string $actBootstrapViewPortSizeType):void
{
 ...
 function getBootstrapViewPortSizeType():string
 {
 	if($this->bootstrapViewPortSizeType == STRING_NULL)
 	 return DEFAULT_BOOTSTRAP_VIEWPORT_SIZE_TYPE_1;
 	else
 ...
 function putContainerCenter():void
 {
	$interfacesContainerCenter = $this->getInterfacesContainerCenter();
	$this->putContainer($interfacesContainerCenter);
 }	
 ...
 { 
  ...
  $bootstrapViewPortSizeType = $this->getBootstrapViewPortSizeType();
  $leftCss = "col" . STRING_MINUS . $bootstrapViewPortSizeType . STRING_MINUS . "4";
  $leftStyle = "float:left";
  $leftStyle = $leftStyle . STRING_SEMICOLON . $this->getContainerLeftStyle();  
  $htmlWriter->putDivOpenTag($intCode . VAR_SEP . "left",
  $leftStyle,(($bootstrapEnabled)?$leftCss:STRING_NULL));
	$this->putContainerLeft();
	$htmlWriter->putGenericHtmlString(DIV_CLOSE_TAG,0);
	$centerCss = "col" . STRING_MINUS . $bootstrapViewPortSizeType . STRING_MINUS . "4";
  $centerStyle = "float:left";
  $centerStyle = $centerStyle . STRING_SEMICOLON . $this->getContainerCenterStyle();  
  $htmlWriter->putDivOpenTag($intCode . VAR_SEP . "center",$centerStyle,
  (($bootstrapEnabled)?$centerCss:STRING_NULL));
	$this->putContainerCenter();
	$htmlWriter->putGenericHtmlString(DIV_CLOSE_TAG,0);
	$rightCss = "col" . STRING_MINUS . $bootstrapViewPortSizeType . STRING_MINUS . "4";
