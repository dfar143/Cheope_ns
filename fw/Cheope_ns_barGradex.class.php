...
class Cheope_ns_barGradex extends Html_data_interface
{	
 Use Creator;
	
 const ERROR_1="Cheope_ns_barGradex:Numero campi dati errato.";
 ...
 {
 	$bplot = Creator::create(getClassNameForCreate(Classes_info::BARPLOT_CLASS),STRING_NULL,$actDataY);
 	return $bplot; 
 }
