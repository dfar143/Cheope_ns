...
require_once("Javascript_data_template.class.php");
require_once("Javascript_data_fragment.class.php");
...
define('DEFAULT_PAGE_NAME',"prova_5");
define('THIS_PAGE',PAGE_PROVA_5);

class Cheope_ns_prova_5_op_page extends Cheope_ns_page
{
