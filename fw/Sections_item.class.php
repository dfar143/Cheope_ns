...
class Sections_item extends Array_item
{
// const ERROR_1 = "Sections_item:Errore nell'inserimento dell'oggetto. L'oggetto deve essere un item.";
...
//   die(self::ERROR_1);
 ...
 function toString():string
 {
 	...
 	//
 	$item = $this->getItem();
 	$sectionsName = $this->getName();
 	$itemsCount = count($item);
 	$ret = STRING_SLASH . STRING_SLASH . STRING_SPACE . 
 	$sectionsName . STRING_RETURN . STRING_LINE_FEED;
