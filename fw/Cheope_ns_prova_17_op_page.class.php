...
define('DEFAULT_PAGE_NAME',"prova_17");
define('THIS_PAGE',PAGE_PROVA_17);

class Cheope_ns_prova_17_op_page extends Cheope_ns_page
{
 ...
 {	 
  ...
  $interfaceAccordion1 = $interfacesContainer->getInterface(OBJ_PROVA,
  OP_NONE,Interfaces_info::INT_ACCORDION,NUM_1); 
