...
class Std_offCanvas_menu extends Html_data_interface
{
 const ERROR_1="Std_offCanvas_menu.putData:Numero campi dati errato.";
 const TITLES_POS=0;
 const PAGES_POS=1;
 const LINKS_POS=2;
 ...
 function __construct($actObj=OBJ_NONE,string $actOp=OP_NONE,$actNum=STRING_NULL)
 {
  ...
  self::$hasJavascriptEnabledSwitch=false;
