...
define('DEFAULT_PAGE_NAME',"prova_28");
define('THIS_PAGE',PAGE_PROVA_28);

class Cheope_ns_prova_28_op_page extends Cheope_ns_page
{
 ...
 function putClientScriptIncludeCode():void
 {
  ...
  putGenericHtmlString("<script>dojo.require(\"dijit.layout.AccordionContainer\")</script>"); 
  putGenericHtmlString("<script>dojo.require(\"dijit.layout.AccordionPane\")</script>");
  putGenericHtmlString("<script>" .
	"dojo.addOnLoad(function(){dojo.parser.parse();document.body.className='nihilo';dijit.byId('foo').resize();});</script>");
 }
