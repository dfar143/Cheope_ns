...
class Cheope_ns_local_tabs extends Html_data_interface
{ 

// const ERROR_1="Cheope_ns_local_tabs:Errore nell'inserimento dell'interface container.";
// const ERROR_2="Cheope_ns_local_tabs:Errore l'interface container non può essere vuoto.";
 const ERROR_3="Cheope_ns_local_tabs.putData:Numero campi dati errato.";
 const VOICES_POS=0;
 ...
 function putContainer(array $actDataValues):void
 {
  ...
  $htmlWriter->putDivOpenTag($intCode,$style,$cssClass);	  
	$htmlWriter->putTableOpenTag($intCode . VAR_SEP . "inner_table",
	$cssClass,STRING_NULL,STRING_NULL,STRING_NULL,STRING_NULL,STRING_NULL);
  ...
  for($k=0;$k<=$num1-1;$k++)
  {
   ...
   $htmlWriter->putTableColumnOpenTag($intCode . VAR_SEP . "col" . VAR_SEP . self::TAB_FIELD_ID_SUFFIX . VAR_SEP . 
	...
	$htmlWriter->putTableColumnOpenTag(STRING_NULL,self::VOID_TAB_CSS_CLASS,STRING_NULL,
  ...
  $htmlWriter->putTableRowOpenTag(STRING_NULL,STRING_NULL,STRING_NULL);
	$htmlWriter->putTableColumnOpenTag(STRING_NULL,self::TAB_BODY_CSS_CLASS,
	STRING_NULL,STRING_NULL,($num1+1),STRING_NULL,STRING_NULL);
	 ...
	 while($iterator->hasMore())
	 {
	 	...
	 	if($i==$selTab)
	 	{
	 	 ...
	 	 $htmlWriter->putDivOpenTag($intCode . VAR_SEP . self::INNER_DIV_TAB_ID_SUFFIX . 
	 	 VAR_SEP . $i,$style,self::INNER_DIV_TAB_CSS_CLASS,STRING_NULL);
	 	 $ctl->putData();
	 	 $htmlWriter->putGenericHtmlString(DIV_CLOSE_TAG,0);
	 	}
	 	else
