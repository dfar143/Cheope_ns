...
define('DEFAULT_PAGE_NAME',"prova_30");
define('THIS_PAGE',PAGE_PROVA_30);

class Cheope_ns_prova_30_op_page extends Cheope_ns_page
{
 ...
 function putClientScriptIncludeCode():void
 {
  ...
  putGenericHtmlString("<script>dojo.require(\"dijit.ColorPalette\")</script>"); 
