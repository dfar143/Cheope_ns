...
class Cheope_ns_menuBar_2 extends Html_data_interface
{

 //const ERROR_1="Cheope_ns_menuBar_2:Errore nell'inserimento dell'interface container.";
 const ERROR_2="Cheope_ns_menuBar_2:Numero campi dati errato.";
