...
class Cheope_ns_dropdown_topnav extends Html_data_interface
{ 
 const DEFAULT_CSS_CLASS="dropdown_topnav";
 const DEFAULT_CSS_MODULE="dropdown_topnav";
 ...
 function __construct($actObj=OBJ_NONE,string $actOp=OP_NONE,$actNum=STRING_NULL)
 {
  ...
  parent::__construct($actObj,$actOp,self::INT_DROPDOWN_TOPNAV,$actNum);
 ...
 function putMenu_body(array $actValues):void
 {
   ...
   if (is_array($val))
   {
	 $htmlWriter->putDivOpenTag(STRING_NULL,$style,"dropdown_topnav_1"); 
     $htmlWriter->putButtonOpenTag(STRING_NULL,STRING_NULL,"dropbtn_topnav");
     ...
     STRING_NULL,"dropdown-content-topnav");   
     $j=0;	 
