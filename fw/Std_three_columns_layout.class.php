...
class Std_three_columns_layout extends Html_formatted_interface
{ 

// const ERROR_1="Std_three_columns_layout:Errore nell'inserimento dell'interface container di sinistra.";
// const ERROR_2="Std_three_columns_layout:Errore nell'inserimento dell'interface container di destra.";
...
function setBootstrapViewPortSizeType(string $actBootstrapViewPortSizeType):void
{
 ...
 {
 	//if(is_a($actIntContainer,Classes_info::INTERFACES_CONTAINER_CLASS))
