...
class Cheope_ns_resp_bottom_navbar extends Html_data_interface
{ 
 const ERROR_1="Cheope_ns_resp_bottom_navbar.putData:Numero campi dati errato.";
 const DEFAULT_CSS_CLASS="resp_navbar";
 const DEFAULT_CSS_MODULE="resp_bottom_navbar";
 const TITLES_POS=0;
 const PAGES_POS=1;
 const LINKS_POS=2;
 const DEFAULT_NAVBAR_HAMB_ID = "myNavbar";
 const DEFAULT_JAVASCRIPT_MODULE = JS_RESP_BOTTOM_NAVBAR;
 ...
 function __construct($actObj=OBJ_NONE,string $actOp=OP_NONE,$actNum=STRING_NULL)
 {
  ...
  parent::__construct($actObj,$actOp,self::INT_RESP_BOTTOM_NAVBAR,$actNum);
 ...
 function putMenu(array $actDataValues):void
 {
  ...
  $htmlWriter->putDivOpenTag(self::DEFAULT_NAVBAR_HAMB_ID,$style,$cssClass);
  $i=0;
