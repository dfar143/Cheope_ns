...
define('DEFAULT_PAGE_NAME',"prova_21");
define('THIS_PAGE',PAGE_PROVA_21);

class Cheope_ns_prova_21_op_page extends Cheope_ns_page
{
 ...
 function putClientScriptIncludeCode():void
 {
  ...
  putGenericHtmlString("<script>dojo.require(\"dijit.form.NumberSpinner\")</script>");
