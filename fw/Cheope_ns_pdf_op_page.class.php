...
define('DEFAULT_PAGE_NAME',"pdf");
define('THIS_PAGE',"pdf.php");

class Cheope_ns_pdf_op_page extends Cheope_ns_page
{
 ...
 function putBody():void
 {
  ...
  if(isset($_SESSION[SESSION_VAR_ACTIVE_APP]) && $_SESSION[SESSION_VAR_ACTIVE_APP] !== STRING_NULL)
  {
   ...
   $intCtrl2->setDataFieldEvents(array("templates_onChange(this)")); 
   ...
   foreach($files as $ind=>$file)
   {
   	...
   	if(((($num==1)&&(! is_dir($file))))||(($num==2)&&(! is_dir($file))&&($fileItems2[1]==XML_SUFFIX)))
    {
   	 ...
   	 {
    	if((in_array($fileItems[3],array(Interfaces_info::INT_FPDF_TEMPLATE))) &&(! in_array($file,$intFiles))&&
   ...
   $intCtrl3->setDataFieldDomainValueByName(FIELD_TEMPLATES,$intFiles);   
