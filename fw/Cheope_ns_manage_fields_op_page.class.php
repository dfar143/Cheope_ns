...
define('DEFAULT_PAGE_NAME',"manage_fields");
define('THIS_PAGE',"manage_fields.php");

class Cheope_ns_manage_fields_op_page extends Cheope_ns_page
{
 ...
 function putClientScriptIncludeCode():void
 {
  ...
  &&($_SESSION[SESSION_VAR_ACTIVE_APP]==STRING_NULL))||(! isset($_GET["Interfaccia"])))
  {
   $interfaces->deleteByStringInType("javascript");  
  }
  elseif(isset($_GET["Interfaccia"]))
  {
   $intDataTemp1 = $interfaces->getInterface(OBJ_NONE,"manageFieldsOp2",
   Interfaces_info::INT_JAVASCRIPT_DATA_TEMPLATE,NUM_1);
   $interfaccia = $_GET["Interfaccia"];
   $intDataTemp1->setAjaxOpPar($interfaccia);
   $intDataFrag1 = $interfaces->getInterface(OBJ_NONE,"Op2",
   Interfaces_info::INT_JAVASCRIPT_DATA_FRAGMENT,NUM_1);
   $intDataFrag1->setDataFieldDomainValueByPos(0,$interfaccia);
  }
  parent::putClientScriptIncludeCode();
  if(isset($_SESSION[SESSION_VAR_ACTIVE_APP])&& isset($_GET["Interfaccia"]))
  { 
