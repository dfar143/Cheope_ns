...
define('DEFAULT_PAGE_NAME',"prova_23");
define('THIS_PAGE',PAGE_PROVA_23);

class Cheope_ns_prova_23_op_page extends Cheope_ns_page
{
 ...
 function putClientScriptIncludeCode():void
 {
  ...
  putGenericHtmlString("<script>dojo.require(\"dijit.form.FilteringSelect\")</script>");
