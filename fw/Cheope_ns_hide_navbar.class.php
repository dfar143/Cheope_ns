...
class Cheope_ns_hide_navbar extends Html_data_interface
{
 const ERROR_1="Cheope_ns_hide_navbar.putData:Numero campi dati errato.";
 const TITLES_POS=0;
 const PAGES_POS=1;
 const LINKS_POS=2;
 const DEFAULT_CSS_CLASS="hide_navbar";
 const DEFAULT_JAVASCRIPT_MODULE=JS_HIDE_NAVBAR;
 const DEFAULT_CSS_MODULE="hide_navbar";
 const HIDE_NAVBAR_HEADER_ID = "hide_navbar";
 ...
 function __construct($actObj=OBJ_NONE,string $actOp=OP_NONE,$actNum=STRING_NULL)
 {
  ...
  parent::__construct($actObj,$actOp,self::INT_HIDE_NAVBAR,$actNum);
  $this->setJavascriptModule(CLIENT_HIDE_NAVBAR_CODE_PATH . DIR_SEP . self::DEFAULT_JAVASCRIPT_MODULE);
 ...
 function putMenu(array $actDataValues):void
 {
  ...
  $htmlWriter->putDivOpenTag(self::HIDE_NAVBAR_HEADER_ID,$style,STRING_NULL);
  $i=0;
