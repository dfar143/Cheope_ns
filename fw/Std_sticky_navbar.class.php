...
class Std_sticky_navbar extends Html_data_interface
{
 const ERROR_1="Std_sticky_navbar.putData:Numero campi dati errato.";
 const TITLES_POS=0;
 const PAGES_POS=1;
 const LINKS_POS=2;
 ...
 const STICKY_NAVBAR_HEADER_ID = "sticky_navbar";
 ...
 function putMenu(array $actDataValues):void
 {
  ...
  $htmlWriter->putDivOpenTag(self::STICKY_NAVBAR_HEADER_ID,$style,STRING_NULL);
  $i=0;
