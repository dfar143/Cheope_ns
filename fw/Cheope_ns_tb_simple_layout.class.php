...
class Cheope_ns_tb_simple_layout extends Html_formatted_interface
{ 
 
// const ERROR_1="Prova_Cheope_ns_tb_simple_layout:Errore nell'inserimento dell'interface container di sinistra.";
// const ERROR_2="Prova_Cheope_ns_tb_simple_layout:Errore nell'inserimento dell'interface container di destra.";
 ...
 const DEFAULT_CONTAINER_TOP_STYLE = "width:100%;height:33%";
 const DEFAULT_CONTAINER_CENTER_STYLE = "width:100%;height:33%";
 const DEFAULT_CONTAINER_BOTTOM_STYLE = "width:100%;height:33%";
 ...
 function __construct(string $actOp=OP_NONE,$actNum=STRING_NULL)
 {
  ...
  parent::__construct($actOp,self::INT_TB_SIMPLE_LAYOUT,$actNum);
 }
 ...
 function serialize():void
 {
	...
	//$textPropsArray=array("containerStyle","containerTopStyle","containerCenterStyle","containerBottomStyle");
	...
	if(is_null($intContBottom))
 	...
 	$item5 = array("containerCenterStyle"=>$containerCenterStyle);
 	$serializer->loadItems($item5);
 	$item6 = array("containerBottomStyle"=>$containerBottomStyle);
 	$serializer->loadItems($item6);
 	$item7 = array("interfacesContainerTop"=>$intContTop);
 	$serializer->loadItems($item7);
 	$item8= array("interfacesContainerCenter"=>$intContCenter);
 	$serializer->loadItems($item8);
 	$item9= array("interfacesContainerBottom"=>$intContBottom);
...
function setBootstrapContainerType(string $actBootstrapContainerType):void
{
 ...
 { 
  ...
  $htmlWriter->putDivOpenTag($intCode . VAR_SEP . "top",$topStyle,
  (($bootstrapEnabled)?"row":STRING_NULL));
	$this->putContainerTop();
	$htmlWriter->putGenericHtmlString(DIV_CLOSE_TAG,0);
	
  $centerStyle = $this->getContainerCenterStyle();  
  ...
  $htmlWriter->putDivOpenTag($intCode . VAR_SEP . "bottom",$bottomStyle,
  (($bootstrapEnabled)?"row":STRING_NULL));
