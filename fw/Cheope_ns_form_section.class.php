...
class Cheope_ns_form_section extends Html_data_interface
{
 
 const ERROR_1="Cheope_ns_form_section:Errore incongruenza fra il valore del campo ed il dominio.";
 const ERROR_2="Cheope_ns_form_section:Errore in function putInputCtrl : Incongruenza fra tipo di dati e dominio.";
 const ERROR_3="Cheope_ns_form_section:Campo non trovato in deleteField.";
 const ERROR_4="Cheope_ns_form_section:Indice di riga della griglia fuori limite.";
...
function setBootstrapViewPortSizeType(string $actBootstrapViewPortSizeType):void
{
 ...
 function getFieldLength(string $actFieldName):int|string
 {
 	$fieldsLengths = $this->getFieldsLengths();
 ...
 function putInputCtrl(string $actName,mixed $actValue,string $actType,string $actStyle,
 string $actDomain,
 ...
 string $actRegExp=STRING_NULL,string|int $actDefaultValue=STRING_NULL,
 bool|string $actIsMandatory=STRING_NULL,array|string $actLabels=STRING_NULL,
 ...
 function putInputCtrls(string $actFieldName,mixed $actFieldValue,string $actType,
 ...
 string $actWidth,bool $actLastEl):void
 {
  ...
  // echo "QQQQ" . $fieldDefaultValue . "QQQQ";
  }
