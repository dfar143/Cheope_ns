...
define('DEFAULT_PAGE_NAME',"prova_46");
define('THIS_PAGE',PAGE_PROVA_46);

class Cheope_ns_prova_46_op_page extends Cheope_ns_page
{
 ...
 function putClientScriptIncludeCode():void
 {
	 parent::putClientScriptIncludeCode();
 	 ...
 	 $htmlWriter->putGenericHtmlString("<script>dojo.require(\"dojo.io.script\")</script>");  
 }
