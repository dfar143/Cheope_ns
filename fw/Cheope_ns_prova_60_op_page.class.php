...
define('DEFAULT_PAGE_NAME',"prova_60");
define('THIS_PAGE',PAGE_PROVA_60);

class Cheope_ns_prova_60_op_page extends Cheope_ns_page
{
 ...
 function putClientScriptIncludeCode():void
 {
  ...
  "node:box,showDuration:1000,hideDuration:1000" .
  "});" .
  "var visible=true;" .
  "dojo.connect(box,\"onclick\",function(evt){" .
  "if (visible) t.hide();else t.show();" .
  "visible = !visible;" .
  "});" .  
  "});</script>");  
 }
