...
define('DEFAULT_PAGE_NAME',"prova_57");
define('THIS_PAGE',PAGE_PROVA_57);

class Cheope_ns_prova_57_op_page extends Cheope_ns_page
{
 ...
 function putClientScriptIncludeCode():void
 {
  ...
  "var anim = dojo.fx.wipeOut({node:box});" .
  "anim.play();});" .
  "});</script>");  
 }
