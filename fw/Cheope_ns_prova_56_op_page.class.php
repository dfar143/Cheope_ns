...
define('DEFAULT_PAGE_NAME',"prova_56");
define('THIS_PAGE',PAGE_PROVA_56);

class Cheope_ns_prova_56_op_page extends Cheope_ns_page
{
 ...
 function putClientScriptIncludeCode():void
 {
  ...
  "var anim = dojo.fx.slideTo({node:box,top:\"200\",left:\"200\"});" .
  "anim.play();});" .
  "});</script>");  
 }
