...
define('DEFAULT_PAGE_NAME',"prova_35");
define('THIS_PAGE',PAGE_PROVA_35);

class Cheope_ns_prova_35_op_page extends Cheope_ns_page
{
 ...
 function putClientScriptIncludeCode():void
 {
  ...
  putGenericHtmlString("<script>dojo.require(\"dijit.Tree\")</script>");
  putGenericHtmlString("<script>dojo.require(\"dojo.data.ItemFileWriteStore\")</script>");
  putGenericHtmlString("<script>dojo.require(\"dijit._tree.dndSource\")</script>"); 
  putGenericHtmlString("<script>" .
	"dojo.addOnLoad(function()" .
	"{dojo.parser.parse();document.body.className='nihilo';" .
