...
class Std_fpdf_field_template extends Data_interface
{
 
 const ERROR_1 = "Std_fpdf_field_template:Errore nel nome di un campo.";	
 ...
 function setFpdf(\Std\fpdf\FPDF $actFpdf)
 {
 	$this->fpdf = $actFpdf;
 }
 ...
 function setAlign(int $actAlign):void
 {
 	$this->align = $actAlign;
 }
 ...
 function elabFields(array $actRow,$actNum)
 {
