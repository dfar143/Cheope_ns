...
//
function getFilteredOrdData(string $actTab,string|array $actKeyField,
int|string|array $actKeyValue,string $actOrdField,string $actField):array
{
 $dsn=getDsn();
 $odbcConnId = odbc_connect($dsn,ODBC_USER,ODBC_PASSWORD);
 if (!$odbcConnId)
...
// In pratica ritorna una colonna della tabella.
//
function getFilteredData(string $actTab,string $actKeyField,int|string $actKeyValue,string $actField):array
{
 $dsn=getDsn();
 $odbcConnId = odbc_connect($dsn,ODBC_USER,ODBC_PASSWORD);
 if (!$odbcConnId)
