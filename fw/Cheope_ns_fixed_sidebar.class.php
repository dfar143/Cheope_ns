...
class Cheope_ns_fixed_sidebar extends Html_data_interface
{
 const ERROR_1="Cheope_ns_fixed_sidebar.putData:Numero campi dati errato.";
 const TITLES_POS=0;
 const PAGES_POS=1;
 const LINKS_POS=2;
 const DEFAULT_CSS_CLASS="fixed_sidebar";
 const DEFAULT_CSS_MODULE="fixed_sidebar";
 ...
 function __construct($actObj=OBJ_NONE,string $actOp=OP_NONE,$actNum=STRING_NULL)
 {
  ...
  parent::__construct($actObj,$actOp,self::INT_FIXED_SIDEBAR,$actNum);
