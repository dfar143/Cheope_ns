...
class Std_sheet extends Html_data_interface
{
 
 const ERROR_1="Std_sheet:Errore nella definizione dell'interfaccia.";
    ...
    elseif(is_array($fieldValues))
	  {
	   $fieldValue = $fieldValues;
		...
		$intCode . VAR_SEP . self::FIELD_VALUE_CLASS_SUFFIX);
