...
class Std_form extends Html_data_interface
{
 Use Creator_B;	
 ...
 const ERROR_1="Std_form:Errore incongruenza fra il valore del campo ed il dominio.";
 const ERROR_2="Std_form:Errore in function putInputCtrl : Incongruenza fra tipo di dati e dominio.";
 const ERROR_3="Std_form:Campo non trovato in deleteField.";
...
// private $jQueryValidatorEnabled = false;
 ...
 function serialize():void
 {
    ...
    $fieldsSelectedItems = $this->getFieldsSelectedItems();	
 	$item24 = array("\$fieldsSelectedItems"=>$fieldsSelectedItems);
 ...
 function getLabelSpacerWidth():string
 {
...
function putInputCtrl(string $actName,string|int|bool|array $actValue,string $actType,
string $actDomain,int|string $actLength=STRING_NULL,
int|string $actStop=STRING_NULL,
int|string $actTabIndex=STRING_NULL,
...
string $actOnClick=STRING_NULL):void
{
 ...
 $factory = Creator_B::create_b("PutInputCtrl_factory",STRING_NULL,
 $actName,$actValue,
...
mixed $actFieldValue,string $actType,
string $actDomain,int $actPos)
{
 $htmlWriter = $this->getHtmlWriter(); 
 $intCode = $this->getInterfaceId();
