...
define('DEFAULT_PAGE_NAME',"modules_analysis_2");
define('THIS_PAGE',"modules_analysis_2.php");


class Cheope_ns_modules_analysis_2_op_page extends Cheope_ns_page
{
 ...
 function putClientScriptIncludeCode():void
 {
  ...
  if(isset($_SESSION[SESSION_VAR_ACTIVE_APP]))
  {
   ...
   $intTxtEditor = $interfaces->getInterface(OBJ_NONE,'Op4',
   Interfaces_info::INT_JAVASCRIPT_DATA_ACE_TXTEDITOR,NUM_1);
