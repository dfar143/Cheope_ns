...
static function setFieldsConstsDef(string $actApp,array $actIds)
{
 $ids = $actIds;
 $appDir = $actApp;
 $tablePos = $ids[0];
...
static function checkIfIs1NRelationFather(string $actApp,string $actId):string
{
   $appDir =  $actApp;
   $tableName = $actId;
   $appFileName = PREVIOUS_DIR . DIR_SEP . $appDir . 
...
static function checkIfIsInRelation(string $actApp,string $actId):string
{
   $appDir =  $actApp;
   $tableName = $actId;
   $appFileName = PREVIOUS_DIR . DIR_SEP . $appDir . 
...
static function checkIfIsIn1NRelation(string $actApp,string $actId):string
{
   $appDir =  $actApp;
   $tableName = $actId;
   $appFileName = PREVIOUS_DIR . DIR_SEP . $appDir . 
...
static function checkIfKeyCollides(string $actApp,array $actIds):string
{
 $ids = $actIds;
 $tableName = $ids[0];
...
static function checkIfIs1NRelationFatherOf(string $actApp,array $actId):string
{
	 $appDir = $actApp;
	 $ids = $actId;
   $tableName = $ids[0];
...
static function checkIfExistMNRelationLinkTable(string $actApp,array $actIds):string
{
   $appDir =  $actApp;	
   $ids = $actIds;
   $tableName1 = $ids[0];
...
static function checkIfIsSuitablePkKey(string $actApp,array $actIds):string
{
 $ids = $actIds;
 $tablePos = $ids[0];
 $pkKey = $ids[1];
...
//
static function checkIfKeyCollidesWithSonsKeys(string $actApp,array $actIds):string
{
 $ids = $actIds;
 $tablePos = $ids[0];
 $tableName = self::getTableName($actApp,$tablePos);
...
static function checkIfIsSuitableField(string $actApp,array $actIds):string
{
	 $ids = $actIds;
   $tablePos = $ids[0];
   $fieldName = $ids[1];
...
static function createDbStruct(string $actApp):bool
{
   ...
   FILE_NAME_ELEMENTS_SEP . "def_new" .
...
//  
   ...
   FILE_NAME_ELEMENTS_SEP . "const_new" .
   FILE_NAME_ELEMENTS_SEP . APP_LANGUAGE;
...
static function setQuery(string $actApp,array $actIds):bool
{
 ...
 else
 {
  ...
  {   
   ...
   $defObj3A = $sectionArray2[$queryPos*3 + 2];
   $itemsArray1 = $defObj3A->getItem();
   $methodCallObj1 = $itemsArray1[0];  
   $argArray1 = $methodCallObj1->getItem();   
   $varObj1 = $argArray1[0];
...
static function checkIfAliasExists(string $actApp,string $actAlias):string
{
...
static function checkIfBindExists(string $actApp,string $actBind):string
{
 $appFileName = PREVIOUS_DIR . DIR_SEP . $actApp . DIR_SEP . XML_DIR . 
...
static function checkIfTableExists(string $actApp,string $actTable):string
{
 $appFileName = PREVIOUS_DIR . DIR_SEP . $actApp . DIR_SEP . XML_DIR . 
    DIR_SEP . "tables_const_def" .
    FILE_NAME_ELEMENTS_SEP . XML_SUFFIX;
...
static function checkIfDataSourceQueryExists(string $actApp,string $actQuery):string
{
 $appDir = $actApp;
 $appFileName1 = PREVIOUS_DIR . DIR_SEP . $appDir . DIR_SEP . XML_DIR . 
  DIR_SEP . "queries_defines_def" .
...
static function checkIfConnectionExists(string $actApp,string $actConn):string
{
...
static function checkIfXmlModuleExists(string $actApp,string $actId):string
{
 $appFileName = PREVIOUS_DIR . DIR_SEP . $actApp . DIR_SEP . XML_DIR . 
    DIR_SEP . $actId;
 $res='false';
...
static function checkIfJsonModuleExists(string $actApp,string $actId):string
{
...
static function getNodeType(string $actApp,string $actId):string
{
...
static function setAllBinds(string $actApp,array $actIds):bool
{
 ...
 $newSectionArray0[0] = $sectionObj0->getItem()[0];
 //print_r($actIds);
 //die("AAA");
 foreach($actIds as $ind=>$bind)
 {
 ...
 $appFileName = PREVIOUS_DIR . DIR_SEP . $actApp . DIR_SEP . XML_DIR . 
    DIR_SEP . "binds_container_definition_def" .
    FILE_NAME_ELEMENTS_SEP . XML_SUFFIX;
...
static function updateBinds(string $actApp):bool
{
 ...
 if(count($sectionsArray3)>0)
 {
  ...
  $newSectionArray3 = array();
  $newSectionArray3[0] = $sectionArray3[0];
  unset($sectionArray3[0]);
  $i=1;
  $j=0;
  //$k=0;
  //$newSectionArray[0] = $sectionArray3[0];
...
static function checkIfConnectionIsUsed(string $actAppName,string $actConnName):bool
{
 ...
 static function replaceInAllXmlFiles(string $actAppName,
...
// Ritorna tutte le operazioni ajax  per l'applicazione data da $actAppDir
 ...
 static function createAjaxOpClassFile(string $actAjaxOpClass,string $actAppDir):void
 {
  ...
  $ajaxOpClassCode = $ajaxOpClassCode  . "}" . PHP_EOL;
  $ajaxOpClassCode = $ajaxOpClassCode  . PHP_EOL;
  $ajaxOpClassCode = $ajaxOpClassCode  . "function exec_1(string \$actId):array|string|bool|null" . PHP_EOL;
  $ajaxOpClassCode = $ajaxOpClassCode  . "{" . PHP_EOL;
  $ajaxOpClassCode = $ajaxOpClassCode  . "}" . PHP_EOL;
  $ajaxOpClassCode = $ajaxOpClassCode  . "}" . PHP_EOL;
  $ajaxOpClassCode = $ajaxOpClassCode  . PHP_EOL;	
 ...
 static function generateAjaxOpsConfigurationFiles(string $actAppDir):string
 {
 	$appDir = $actAppDir;
  $appFileName1 = PREVIOUS_DIR . DIR_SEP . $appDir . DIR_SEP . XML_DIR . 
 ...
 static function generateAjaxOpsClassesFiles(string $actAppDir):string
 {
 	$appDir = $actAppDir;
  $appFileName1 = PREVIOUS_DIR . DIR_SEP . $appDir . DIR_SEP . XML_DIR . 
 ...
 static function fixDbXmlFiles(string $actAppDir):string
 {
   $appDir = $actAppDir;
   
   $dbStructFileNameOld = PREVIOUS_DIR . DIR_SEP . $appDir . 
   DIR_SEP . FRAMEWORK_DIR . DIR_SEP . strToLower($appDir) . VAR_SEP . "db_struct" . 
   FILE_NAME_ELEMENTS_SEP . "def_new" .
   FILE_NAME_ELEMENTS_SEP . APP_LANGUAGE;
   $dbStructFileNameNew = PREVIOUS_DIR . DIR_SEP . $appDir . 
   DIR_SEP . FRAMEWORK_DIR . DIR_SEP . strToLower($appDir) . VAR_SEP . "db_struct" . 
   FILE_NAME_ELEMENTS_SEP . "def" .
   FILE_NAME_ELEMENTS_SEP . APP_LANGUAGE;
   
   $fieldsConstsFileNameOld = PREVIOUS_DIR . DIR_SEP . $appDir . 
   DIR_SEP . FRAMEWORK_DIR . DIR_SEP . strToLower($appDir) . VAR_SEP . "fields" . 
   FILE_NAME_ELEMENTS_SEP . "def_new" .
   FILE_NAME_ELEMENTS_SEP . APP_LANGUAGE;
   
   $fieldsConstsFileNameNew = PREVIOUS_DIR . DIR_SEP . $appDir . 
   DIR_SEP . FRAMEWORK_DIR . DIR_SEP . strToLower($appDir) . VAR_SEP . "fields" . 
   FILE_NAME_ELEMENTS_SEP . "def" .
   FILE_NAME_ELEMENTS_SEP . APP_LANGUAGE;
   
   $tablesConstsFileNameOld = PREVIOUS_DIR . DIR_SEP . $appDir . 
   DIR_SEP . FRAMEWORK_DIR . DIR_SEP . strToLower($appDir) . VAR_SEP . "tables" . 
   FILE_NAME_ELEMENTS_SEP . "const_new" .
   FILE_NAME_ELEMENTS_SEP . APP_LANGUAGE;

  $tablesConstsFileNameNew = PREVIOUS_DIR . DIR_SEP . $appDir . 
   DIR_SEP . FRAMEWORK_DIR . DIR_SEP . strToLower($appDir) . VAR_SEP . "tables" . 
   FILE_NAME_ELEMENTS_SEP . "const" .
   FILE_NAME_ELEMENTS_SEP . APP_LANGUAGE;   
 
 $dbQueriesFileNameOld = PREVIOUS_DIR . DIR_SEP . $appDir . 
   DIR_SEP . FRAMEWORK_DIR . DIR_SEP . strToLower($appDir) . VAR_SEP . "db_queries" . 
   FILE_NAME_ELEMENTS_SEP . "def_new" .
   FILE_NAME_ELEMENTS_SEP . APP_LANGUAGE;   
 $dbQueriesFileNameNew = PREVIOUS_DIR . DIR_SEP . $appDir . 
   DIR_SEP . FRAMEWORK_DIR . DIR_SEP . strToLower($appDir) . VAR_SEP . "db_queries" . 
   FILE_NAME_ELEMENTS_SEP . "def" .
   FILE_NAME_ELEMENTS_SEP . APP_LANGUAGE;
 
 $dbConnectionsFileNameOld = PREVIOUS_DIR . DIR_SEP . $appDir . 
   DIR_SEP . FRAMEWORK_DIR . DIR_SEP . strToLower($appDir) . VAR_SEP . "db_connections" . 
   FILE_NAME_ELEMENTS_SEP . "def_new" .
   FILE_NAME_ELEMENTS_SEP . APP_LANGUAGE; 
 $dbConnectionsFileNameNew = PREVIOUS_DIR . DIR_SEP . $appDir . 
   DIR_SEP . FRAMEWORK_DIR . DIR_SEP . strToLower($appDir) . VAR_SEP . "db_connections" . 
   FILE_NAME_ELEMENTS_SEP . "def" .
   FILE_NAME_ELEMENTS_SEP . APP_LANGUAGE;

 $dbBindsFileNameOld = PREVIOUS_DIR . DIR_SEP . $appDir . 
   DIR_SEP . FRAMEWORK_DIR . DIR_SEP . strToLower($appDir) . VAR_SEP . "db_binds" . 
   FILE_NAME_ELEMENTS_SEP . "def_new" .
   FILE_NAME_ELEMENTS_SEP . APP_LANGUAGE;
 $dbBindsFileNameNew = PREVIOUS_DIR . DIR_SEP . $appDir . 
   DIR_SEP . FRAMEWORK_DIR . DIR_SEP . strToLower($appDir) . VAR_SEP . "db_binds" . 
   FILE_NAME_ELEMENTS_SEP . "def" .
   FILE_NAME_ELEMENTS_SEP . APP_LANGUAGE; 
   ...
   if (file_exists($dbStructFileNameOld))
   {
	if(! rename($dbStructFileNameOld,$dbStructFileNameNew))
	 $res=$res && false;
   }
   
   
   if (file_exists($fieldsConstsFileNameOld))
   {
	if(! rename($fieldsConstsFileNameOld,$fieldsConstsFileNameNew))
	 $res=$res && false;
   }
   
   if (file_exists($tablesConstsFileNameOld))
   {
	if(! rename($tablesConstsFileNameOld,$tablesConstsFileNameNew))
	 $res=$res && false;
   }
 
   if (file_exists( $dbQueriesFileNameOld))
   {
	if(! rename($dbQueriesFileNameOld,$dbQueriesFileNameNew))
	 $res=$res && false;
   }

   if (file_exists( $dbConnectionsFileNameOld))
   {
	if(! rename($dbConnectionsFileNameOld,$dbConnectionsFileNameNew))
	 $res=$res && false;
   }

   if (file_exists( $dbBindsFileNameOld))
   {
	if(! rename($dbBindsFileNameOld,$dbBindsFileNameNew))
	 $res=$res && false;
   } 
