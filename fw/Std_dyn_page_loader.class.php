...
require_once("std_interfaces_requires.def.php");
require_once("std_db_struct.def.php");
require_once("std_db_queries.def.php");
require_once("Creator.tra.php");

define('STD_DYN_PAGE_LOADER_ERROR_1',"Impostare il nome del file.");

class Std_dyn_page_loader extends Html_formatted_interface
{
	Use Creator;
	
	const STD_DYN_PAGE_LOADER_ERROR_1="dyn_page_loader:Errore impostare il nome del file.";
	...
	function __construct(string $actOp=STRING_NULL,$actNum=STRING_NULL)
	{
		...
		parent::__construct($actOp,self::INT_DYN_PAGE_LOADER,$actNum);
 ...
 function isStandard():bool
 {
  ...
  function isDecorator():bool
  {
   return false;
    ...
    die(self::STD_DYN_PAGE_LOADER_ERROR_1);
  }
 ...
 function putData():void
 {
 	...
 	//$serializer = self::createXmlInterfaceSerializer();
 	$dir = STRING_POINT . DIR_SEP . XML_SUFFIX;
 	//$serializer->setDir($dir);
