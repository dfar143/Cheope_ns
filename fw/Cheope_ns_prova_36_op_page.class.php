...
define('DEFAULT_PAGE_NAME',"prova_36");
define('THIS_PAGE',PAGE_PROVA_36);

class Cheope_ns_prova_36_op_page extends Cheope_ns_page
{
 ...
 function putClientScriptIncludeCode():void
 {
  ...
  putGenericHtmlString("<script>dojo.require(\"dijit.Editor\")</script>");
