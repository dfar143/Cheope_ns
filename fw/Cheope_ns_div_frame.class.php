...
class Cheope_ns_div_frame extends Html_formatted_interface
{
 
// const ERROR_1="Cheope_ns_div_frame:Errore nell'inserimento dell'interface container.";
 ...
 function serialize():void
 {
	...
	//$booleanPropsArray=array("bootstrapEnabled");
 ...
 function getCssClass():string
{
 ...
 function setFrameWidth(string $actFrameWidth):void
 {
 ...
 function setFrameHeight(string $actFrameHeight):void
 {
