...
class Std_frame extends Html_formatted_interface
{
 
// const ERROR_1="Std_frame:Errore nell'inserimento dell'interface container.";
 ...
 function getCssClass():string
{
 ...
 function setFrameWidth(int|string $actFrameWidth):void
 {
  $this->frameWidth = $actFrameWidth;
 }
 
 function getFrameWidth():int|string
 {
 ...
 function setFrameHeight(int|string $actFrameHeight):void
 {
  $this->frameHeight = $actFrameHeight;
 }
 
 function getFrameHeight():int|string
 {
