...
class Cheope_ns_sticky_navbar extends Html_data_interface
{
 const ERROR_1="Cheope_ns_sticky_navbar.putData:Numero campi dati errato.";
 const TITLES_POS=0;
 const PAGES_POS=1;
 const LINKS_POS=2;
 const DEFAULT_CSS_CLASS="sticky_navbar";
 const DEFAULT_JAVASCRIPT_MODULE=JS_STICKY_NAVBAR;
 const DEFAULT_CSS_MODULE="sticky_navbar";
 const STICKY_NAV_BAR_HEADER_ID = "sticky_navbar";
 ...
 function __construct($actObj=OBJ_NONE,string $actOp=OP_NONE,$actNum=STRING_NULL)
 {
  ...
  parent::__construct($actObj,$actOp,self::INT_STICKY_NAVBAR,$actNum);
  $this->setJavascriptModule(CLIENT_STICKY_NAVBAR_CODE_PATH . DIR_SEP . self::DEFAULT_JAVASCRIPT_MODULE);
 ...
 function putMenu(array $actDataValues):void
 {
  ...
  $htmlWriter->putDivOpenTag(self::STICKY_NAV_BAR_HEADER_ID,$style,STRING_NULL);
  $i=0;
