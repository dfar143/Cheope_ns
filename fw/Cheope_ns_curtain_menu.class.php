...
class Cheope_ns_curtain_menu extends Html_data_interface
{
 const ERROR_1="Cheope_ns_curtain_menu:Numero campi dati errato.";
 ...
 function __construct($actObj=OBJ_NONE,string $actOp=OP_NONE,$actNum=STRING_NULL)
 {
 	...
 	self::$hasJavascriptEnabledSwitch=true; 
...
function putCurtainMenu(array $actDataValues):void
{
 ...
 foreach($labels as $ind => $val)
 {
	...
	if($itemsImgSrc != STRING_NULL)
	{
	 ...
	 $htmlWriter->putImgTag(STRING_NULL,STRING_NULL,STRING_NULL,
	 STRING_NULL,$itemsImgSrc);
