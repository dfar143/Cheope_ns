...
define('DEFAULT_PAGE_NAME',"prova_22");
define('THIS_PAGE',PAGE_PROVA_22);

class Cheope_ns_prova_22_op_page extends Cheope_ns_page
{
 ...
 function putClientScriptIncludeCode():void
 {
  ...
  putGenericHtmlString("<script>dojo.require(\"dijit.form.DateTextBox\")</script>");
  putGenericHtmlString("<script>dojo.require(\"dijit.Tooltip\")</script>");
  putGenericHtmlString("<script>function formatValue(actVal,actObj){return actVal.toUpperCase();}</script>");
  putGenericHtmlString("<script>" .
	"dojo.addOnLoad(function(){document.body.className='tundra';dojo.parser.parse();});</script>");
 }
 ...
 {	 
  ...
  if(isset($_POST["prova"]))
   echo $_POST["prova"];
  if(isset($_POST["dataOdierna"]))
   echo $_POST["dataOdierna"];
