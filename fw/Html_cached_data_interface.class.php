...
abstract class Html_cached_data_interface extends 
Html_formatted_interface implements Init_1,Init_2,Init_3
{
 Use Creator;		
 const ERROR_1 = "Html_cached_data_interface:L'oggetto ritornato non è un Int_domain";
 //const ERROR_2 = "Html_cached_data_interface:Errore nell'inserimento del grafo del database.";
 const ERROR_3 = "Html_cached_data_interface:Errore nell'inserimento del Nodo dati.";
 //const ERROR_4 = "Html_cached_data_interface:Errore nell'inserimento dell'int_fields_container.";
 const ERROR_5 = "Html_cached_data_interface:Errore in setDataFieldDomainValueByPos: Oggetto dominio campo dati non esistente.";
 const ERROR_6 = "Html_cached_data_interface:Errore in setDataFieldsDomainsValues:Oggetto dominio campo dati non esistente.";
 const ERROR_7= "Html_cached_data_interface:Errore:Grafo del database vuoto.";
 const ERROR_8= "Html_cached_data_interface:Errore:Contenitore delle queries vuoto.";
 const ERROR_9 ="Html_cached_data_interface:Errore nell'inserimento del contenitore queries.";
 //const ERROR_9="Cached_data_interface:Errore nell'inserimento del contenitore queries."; 	
 const ERROR_10="Html_cached_data_interface:Errore Oggetto non valido.";
 const ERROR_11="Html_cached_data_interface:Errore Dominio non settato per il campo.";
 ...
 function __construct($actObj,string $actOp=OP_NONE,string $actType=STRING_NULL,$actNum=STRING_NULL)
 {
  $this->setObj($actObj);
  $this->intFieldsContainer = self::createIntFieldsContainer();
	parent::__construct($actOp,$actType,$actNum);
	$cachedProps = array("dataFields"=>array(),
 ...
 {
 	$intFieldsContainer = Creator::create(getClassNameForCreate(Classes_info::INT_FIELDS_CONTAINER_CLASS),STRING_NULL);
 ...
 function getFieldsFromDataSource():array
 {
 ...
 function setObj(object|string|null $actObj)
 {
 ...
 function setIntFieldsContainer(?Int_fields_container $actIntFieldsContainer)
 {
...
// 
 ...
 function setAndPreserveDataFields(array $actDataFields):void
 {
  ...
  $objCache->setPropValByMethodName("setDataFields",$actDataFields);
 }
 ...
 function setDataFieldsDomains(array $actDataFieldsDomains):bool
 {
  ...
  $objCache->setPropValByMethodName("setDataFieldsDomains",$actDataFieldsDomains);
 ...
 function setDataFieldDomainByName(string $actFieldName,$actVal):bool
 {
 	$fieldsDomains = array();
 	$fieldsDomainsObjs = array();
  $objCache = $this->getObjCache();
 ...
 function setDataFieldsDomainsValues(array $actDataFieldsDomainsValues):bool
 {
  ...
  $objCache->setPropValByMethodName("setDataFieldsDomainsValues",$actDataFieldsDomainsValues);
 	$objCache->setPropValByMethodName("setDataFieldsDomainsObjs",$fieldsDomainsObjs); 
 	return true;  	
 }
 ...
 array|string|int|float|null $actFieldVal=FIELD_NO_VALUE):mixed
  {
 	 //var_dump($this->getDataFieldsDomainsObjs());
   ...
   foreach($rows as $row)
   {
    foreach($dataFields as $dataField)
    {
     ...
     elseif(is_object($fieldValue) && (! is_callable($fieldValue)))
     {
     	...
     	{
       if(is_a($fieldValue,Classes_info::HTML_CACHED_DATA_INTERFACE_CLASS))
       {
