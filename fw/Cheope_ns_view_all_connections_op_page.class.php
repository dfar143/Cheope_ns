...
define('DEFAULT_PAGE_NAME',"view_all_connections");
define('THIS_PAGE',"view_all_connections.php");

class Cheope_ns_view_all_connections_op_page extends Cheope_ns_page
{
