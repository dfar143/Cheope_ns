...
class Cheope_ns_bootstrap_navbar extends Html_data_interface
{
 
// const ERROR_1 = "Cheope_ns_bootstrap_navbar:Errore nell'inserimento dell'interface container.";
 const ERROR_2 = "Cheope_ns_bootstrap_navbar:Numero campi dati errato.";	
...
//
// Metodo anomalo. 
// Stesso nome di quello della classe di base 
