...
require_once(FRAMEWORK_PATH . "Cheope_ns_prova_21_op_page.class.php");


 $interfaceHtmlFragment1 = new Html_fragment(OP_NONE,NUM_1);
 $interfaceHtmlFragment1->setHtmlFragment("<input style=\"color:black;height:70px\" dojoType=\"dijit.form.NumberSpinner\" constrain=\"{min:0,max:10000}\" value=1000></input>");
 ...
 $page = new Cheope_ns_prova_21_op_page();
