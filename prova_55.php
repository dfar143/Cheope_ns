...
require_once(FRAMEWORK_PATH . "Cheope_ns_prova_55_op_page.class.php");

 $intHtmlFragment1 = new Html_fragment(OP_NONE,NUM_1);
 $intHtmlFragment1->setHtmlFragment("<div id=\"box\" class=\"box\">Animate</div>");
...
/* $interfacesContainer->add($interfaceFrame1);
 ...
 $page = new Cheope_ns_prova_55_op_page();
