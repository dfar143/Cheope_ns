...
require_once(FRAMEWORK_PATH . "Cheope_ns_prova_29_op_page.class.php");

 $interfaceHtmlFragment1 = new Html_fragment(OP_NONE,NUM_1);
 $interfaceHtmlFragment1->setHtmlFragment("<div id=\"dialog\" dojoType=\"dijit.Dialog\"> " .
 "So foul and fair a day I have not seen...</div>");
 ...
 $page = new Cheope_ns_prova_29_op_page();
