...
namespace Cheope_ns\fw;
 ...
 require_once(FRAMEWORK_PATH . "Cheope_ns_db_parameters_op_page.class.php");
...
// $interfaceCurtainMenu2 = new Cheope_ns_curtain_menu(OBJ_NONE,OP_NONE,NUM_1);
 ...
 $fieldsDomainsValues = array(array("Tables","Fields","Queries","Import"),
 array("tables.php","fields.php","queries.php","import.php"),
...
// $interfaceMenuBarContainer1 = new Interfaces_container(MENUBAR_CONTAINER_1);
 ...
 $interfaceForm1 = Creator::create(Interfaces_info::INT_HTML_FORM_TAG,STRING_NULL,OP_NONE);
// $interfaceForm1 = new Html_form_tag(OP_NONE);
 $attribs = array("name"=>"form_1","id"=>"form_1",
 "enctype"=>MIME_1,
 "method"=>METHOD_POST,
 "action"=>PAGE_PARAMETRI_DB);
 $interfaceForm1->setAttribs($attribs);

 $interfaceFrame2 = Creator::create(Interfaces_info::INT_HTML_DIV_TAG,STRING_NULL);
// $interfaceFrame2 = new Html_div_tag();
 $dispFields = array(LABEL_GESTIONE_PARAMETRI_DB);
...
// $page = new Cheope_ns_db_parameters_op_page();
 $ajaxOps = array(AJAX_OP_TEST_CONNECTION,
 AJAX_OP_COPY_CONNECTION_TO_DB_PARS,
