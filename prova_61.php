...
require_once(FRAMEWORK_PATH . "Cheope_ns_prova_61_op_page.class.php");

 $intHtmlFragment1 = new Html_fragment(OP_NONE,NUM_1);
 $intHtmlFragment1->setHtmlFragment("<img style=\"position:absolute;left:300px;top:300px;\"" .
 "id=\"ball\" src=\"./img/close.gif\">");
...
/* $interfacesContainer->add($interfaceFrame1);
 ...
 $page = new Cheope_ns_prova_61_op_page();
