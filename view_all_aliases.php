...
namespace Cheope_ns\fw;
 ...
 require_once(FRAMEWORK_PATH . "Cheope_ns_view_all_aliases_op_page.class.php");

 $interfaceJavascriptTemplate2 = Creator::create(Interfaces_info::INT_JAVASCRIPT_DATA_TEMPLATE,STRING_NULL,"viewAllAliasesOp2",NUM_1);
 //$interfaceJavascriptTemplate2 = new Javascript_data_template("viewAllAliasesOp2",NUM_1);
 $dataFields = array(FIELD_ALIAS);
 ...
 "<td width=\"90%\"><input id=\"Name_id_{COUNT}\" value=\"{ALIAS}\" onchange=\"input_onChange(this);\"></input></td>" .
 "<td width=\"10%\"><img src=\"./img/close.gif\"" .
 " onclick=\"" .
 "var parent=$(this).parent().parent();" .
 "var removingTableName=parent.find('input').val();" .
 "ajaxHandler.synServerCall('ajax_handler.php','checkIfNodeIsUsed',removingTableName,'text',/[.]*\\\\\w[.]*/);" .
 ...
 $interfaceJavascriptTemplate1 = Creator::create(Interfaces_info::INT_JAVASCRIPT_DATA_TEMPLATE,STRING_NULL,"viewAllAliasesOp1",NUM_1); 
 //$interfaceJavascriptTemplate1 = new Javascript_data_template("viewAllAliasesOp1",NUM_1);
 ...
 $interfaceJavascriptTemplate1->setJavascriptTemplate("<table id=\"aliases\" cellpadding=\"5\" width=\"350\">" .
 "<thead>" .
 "<tr>" .
 "<th>" . LABEL_ALIASES . "</th>" .
 "<th></th>" .
 ...
 $interfaceJavascriptFrag1 = Creator::create(Interfaces_info::INT_JAVASCRIPT_FRAGMENT,STRING_NULL,"viewAllAliasesOp3",NUM_1); 
 //$interfaceJavascriptFrag1 = new Javascript_fragment("viewAllAliasesOp3",NUM_1);
 ...
 "new dojo.dnd.Source(\"tbody_id\",{skipForm:true," .
    ...
    "td4.appendChild(img);" .
    "tr.appendChild(td4);" .
    "\$(input).data(\"alias_name\",input.value);" .
    "return {node: tr, data: actItem, type: \"text\"};" .
  	"}" .
    " });");

  $interfaceJavascriptFrag2 = Creator::create(Interfaces_info::INT_JAVASCRIPT_FRAGMENT,STRING_NULL,"viewAllAliasesOp4",NUM_1);
  //$interfaceJavascriptFrag2 = new Javascript_fragment("viewAllAliasesOp4",NUM_1);
  $interfaceJavascriptFrag2->setHookId(STRING_NULL);
  $interfaceJavascriptFrag2->setJavascriptFragment("\$(\"#tbody_id input\").each(" .
 "function(){var name=\$(this).val();\$(this)" .
 ".data(\"alias_name\",name);\$(this).data(\"old_alias_name\",name);});");
...
// $decoratedIntFrame2 = new Html_fieldset_decorator($interfaceFrame2);
 ...
 //$page = new Cheope_ns_view_all_aliases_op_page();
 $ajaxOps = array(AJAX_OP_SET_ALL_ALIASES,
 AJAX_OP_CHECK_IF_TABLE_EXISTS,
 AJAX_OP_UPDATE_BINDS,
 AJAX_OP_CHECK_IF_ALIAS_EXISTS,
 AJAX_OP_GET_NODE_TYPE,
 AJAX_OP_RENAME_ALIAS_NAME,
